...
IFLAG += -D__SIM_DDS__
IFLAG += -D__DSP48E2__
IFLAG += -I../../../src/beh -I../../../src/lib -I../../../src/inc -I../../../src/top -Wno-unknown-pragmas
...
$(ObjDir)/tb_top_SA.c_pre.c.tb.o : tb_top_SA.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) tb_top_SA.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/DUT.c_pre.c.tb.o : DUT.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) DUT.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/DUFT_ap_ctrl_chain.c_pre.c.tb.o : DUFT_ap_ctrl_chain.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) DUFT_ap_ctrl_chain.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/top_standalone.c_pre.c.tb.o : top_standalone.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) top_standalone.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
