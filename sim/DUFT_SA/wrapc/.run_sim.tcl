...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "top_standalone.autotvin.dat"
	set constFileTvOut       "top_standalone.autotvout.dat"
	set constFileHdlTvIn     "top_standalone.autohdltvin.dat"
	set constFileHdlTvOut    "top_standalone.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
