...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.top_standalone.autotvin_test_input.dat"
         "c.top_standalone.autotvout_dut_output.dat"
         "c.top_standalone.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.top_standalone.autotvout_dut_output.dat"
         "rtl.top_standalone.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
