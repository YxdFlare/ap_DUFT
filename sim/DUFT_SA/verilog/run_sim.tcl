...
if {[file isfile top_standalone.autotvin.dat]} {
	file delete -force top_standalone.autotvin.dat
}

if {[file isfile top_standalone.autotvout.dat]} {
	file delete -force top_standalone.autotvout.dat
}
